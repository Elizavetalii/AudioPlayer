...
namespace AudioPlayer
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ListeningHistory_Click(object sender, RoutedEventArgs e)
        {
            ListeningHistory historyWindow = new ListeningHistory();
            foreach (var audio in AudioPlayer.GetListeningHistory())
            {
                historyWindow.ListBoxHistory.Items.Add(Path.GetFileName(audio));
            }
            historyWindow.ShowDialog();

            if (historyWindow.DialogResult == true)
            {
                int selectedIndex = historyWindow.ListBoxHistory.SelectedIndex;
                AudioPlayer.PlaySelectedAudio(AudioPlayer.GetListeningHistory()[selectedIndex], Media);
            }        
        }
